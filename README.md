...
1. Clonar via prompt de comando o projeto em uma pasta de sua preferência: `git clone https://github.com/cicerorod/igti-fullstack-mod1-cadastro-de-nomes.git`
2. Acessar a pasta principal do projeto via prompt de comando. Ex: `cd igti-fullstack-mod1-cadastro-de-nomes`;
...
1. Faça o _fork_ do projeto (<https://github.com/cicerorod/igti-fullstack-mod1-cadastro-de-nomes/fork>)
